/* rygel-core-2.8.vapi generated by valac 0.57.0.345-d680, do not modify. */
...
namespace Rygel {
	...
	[CCode (cheader_filename = "rygel-core.h")]
	public class Dlna150Hacks : GLib.Object {
	...
	public interface Configuration : GLib.Object {
		...
		public Gee.ArrayList<string> get_string_list_with_default (string section, string key, Gee.ArrayList<string> @default);
